...
public class ReachCarProblemDM implements ProblemBounded, ProblemDiscreteAction, ProblemContinuousAction {
  ...
  public static final ActionArray DRIFTLEFT = new ActionArray(MaxActionValue,0.5);
  public static final ActionArray DRIFTRIGHT = new ActionArray(-MaxActionValue,0.5);
  ...
  public ReachCarProblemDM(Random random) {
    this(random, -1);
  }

  public ReachCarProblemDM(Random random, int episodeLengthMax) {
    this(random, episodeLengthMax, "donington.track");
  }
  
  public ReachCarProblemDM(Random random, int episodeLengthMax, String trackString) {
	    this.random = random;
  ...
  protected void update(ActionArray action) {
      ...
      else if(action.equals(DRIFTLEFT)) {
    	  this.car.steerLeft(true);
    	  this.car.steerRight(false);
    	  this.car.setMotorOn(false);
      }
      ...
      else if(action.equals(DRIFTRIGHT)) {
    	  this.car.steerLeft(false);
