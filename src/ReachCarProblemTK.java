...
public class ReachCarProblemTK implements ProblemBounded, ProblemDiscreteAction, ProblemContinuousAction {
  ...
  public ReachCarProblemTK(Random random) {
    this(random, -1);
  }

  public ReachCarProblemTK(Random random, int episodeLengthMax) {
    this(random, episodeLengthMax, "circle.track");
  }
  
  public ReachCarProblemTK(Random random, int episodeLengthMax, String trackString) {
	    this.random = random;
