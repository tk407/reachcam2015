...
public class ReachCarProblemNathan implements ProblemBounded, ProblemDiscreteAction, ProblemContinuousAction {
  ...
  public ReachCarProblemNathan(Random random) {
    this(random, -1);
  }

  public ReachCarProblemNathan(Random random, int episodeLengthMax) {
    this(random, episodeLengthMax, "donington.track");
  }
  
  public ReachCarProblemNathan(Random random, int episodeLengthMax, String trackString) {
	    this.random = random;
